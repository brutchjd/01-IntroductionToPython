...
blueTurt = rg.SimpleTurtle()
blueTurt.pen = rg.Pen('blue', 5)

blueTurt.left(90)
blueTurt.forward(200)
blueTurt.pen_up()
blueTurt.go_to(rg.Point(100,-40))
blueTurt.pen_down()
blueTurt.pen = rg.Pen('green', 10)
blueTurt.set_heading(270)
blueTurt.forward(150)
